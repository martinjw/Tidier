...
namespace TidyNet
{
    ...
    public class TidyOptions
    {
        ...
        */
        ...
        /// <summary>
        /// Gets or sets a value indicating whether to warn whether table should have summary attribute (not applicable for HTML5).
        /// </summary>
        public bool NoTableSummary { get; set; }

        /// <summary>
        /// If <c>true</c>, create warnings for presentational tags and attributes.
        /// </summary>
        /// <value>
        ///   <c>true</c> if presentational tags and attributes found.
        /// </value>
        public bool WarnPresentational { get; set; }

        /// <summary>
        /// Gets or sets the extension (normally ".html"). Used for directory scanning only.
        /// </summary>
        /// <value>
        /// The extension.
        /// </value>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether to suppress information messages
        /// </summary>
        /// <value>
