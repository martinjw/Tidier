...
namespace TidyNet
{
    ...
    internal class Lexer
    {
        ...
        */
        ...
        {
            if ((versions & HtmlVersion.Html5) != HtmlVersion.Unknown)
            {
        ...
        public virtual bool SetXhtmlDocType(Node root)
        {
            ...
            if (Options.DocType == TidyNet.DocType.Auto)
            {
                ...
                if ((this.versions & HtmlVersion.Html5) != 0)
                {
                    /* use XHTML 5 */
                    fpi = "Html5";
                    sysid = voyager_strict;
                }
                else if ((this.versions & HtmlVersion.Html40Strict) != 0)
                {
                    /* use XHTML strict */
            ...
            else if (Options.DocType == TidyNet.DocType.Html5)
            {
                fpi = string.Empty;
                sysid = string.Empty;
            }
            ...
            if ((versions & HtmlVersion.Html5) != 0 || Options.DocType == DocType.Html5)
            {
                AddStringLiteral("html");
            }
            else //not html5
            {
        ...
        public virtual bool FixDocType(Node root)
        {
            ...
            if (Options.DocType == DocType.Html5)
            {
                AddStringLiteral("html");
            }
            else
