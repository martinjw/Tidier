        ...
        private static Attribute[] _attrs = new Attribute[] 
            {
                ...
                new Attribute("align", HtmlVersion.All, AttrCheckImpl.CheckAlign, true), 
                ...
                new Attribute("autocomplete", HtmlVersion.Html5, AttrCheckImpl.CheckBool), 
                new Attribute("autofocus", HtmlVersion.Html5, AttrCheckImpl.CheckBool), 
                new Attribute("autoplay", HtmlVersion.Html5, AttrCheckImpl.CheckBool), 
                new Attribute("axis", HtmlVersion.Html40, null), 
                new Attribute("background", HtmlVersion.Loose, AttrCheckImpl.CheckUrl, true), 
                new Attribute("bgcolor", HtmlVersion.Loose, null, true), 
                new Attribute("bgproperties", HtmlVersion.Proprietary, null, true), 
                new Attribute("border", HtmlVersion.All, AttrCheckImpl.CheckBool, true), 
                new Attribute("bordercolor", HtmlVersion.Microsoft, null, true), 
                new Attribute("bottommargin", HtmlVersion.Microsoft, null, true), 
                new Attribute("cellpadding", HtmlVersion.From32, null, true), 
                new Attribute("cellspacing", HtmlVersion.From32, null, true), 
                ...
                new Attribute("clear", HtmlVersion.Loose, null, true), 
                ...
                new Attribute("color", HtmlVersion.Loose, null, true), 
                ...
                new Attribute("controls", HtmlVersion.Html5, null), 
                ...
                new Attribute("face", HtmlVersion.Loose, null, true), 
                new Attribute("for", HtmlVersion.Html40, null), 
                new Attribute("form", HtmlVersion.Html5, null), 
                new Attribute("formaction", HtmlVersion.Html5, null), 
                new Attribute("formmethod", HtmlVersion.Html5, null), 
                new Attribute("formnovalidate", HtmlVersion.Html5, AttrCheckImpl.CheckBool), 
                new Attribute("formtarget", HtmlVersion.Html5, null), 
                new Attribute("frame", HtmlVersion.Html40, null), 
                new Attribute("frameborder", HtmlVersion.Frames, null, true), 
                new Attribute("framespacing", HtmlVersion.Proprietary, null), 
                new Attribute("gridx", HtmlVersion.Proprietary, null, true), 
                new Attribute("gridy", HtmlVersion.Proprietary, null, true), 
                new Attribute("headers", HtmlVersion.Html40, null), 
                new Attribute("height", HtmlVersion.All, null, true), 
                ...
                new Attribute("inputmode", HtmlVersion.Html5, null), 
                new Attribute("ismap", HtmlVersion.All, AttrCheckImpl.CheckBool), 
                new Attribute("itemscope", HtmlVersion.Html5, AttrCheckImpl.CheckBool), 
                new Attribute("itemprop", HtmlVersion.Html5, null), 
                new Attribute("itemtype", HtmlVersion.Html5, null), 
                new Attribute("kind", HtmlVersion.Html5, null), 
                new Attribute("label", HtmlVersion.Html40, null), 
                new Attribute("lang", HtmlVersion.Html40, null), 
                new Attribute("language", HtmlVersion.Loose, null, true), 
                ...
                new Attribute("list", HtmlVersion.Html5, null), 
                new Attribute("longdesc", HtmlVersion.Html40, AttrCheckImpl.CheckUrl), 
                new Attribute("loop", HtmlVersion.Html5, AttrCheckImpl.CheckBool), 
                ...
                new Attribute("max", HtmlVersion.Html5, null), 
                ...
                new Attribute("min", HtmlVersion.Html5, null), 
                ...
                new Attribute("noresize", HtmlVersion.Frames, AttrCheckImpl.CheckBool, true), 
                new Attribute("noshade", HtmlVersion.Loose, AttrCheckImpl.CheckBool, true), 
                new Attribute("nowrap", HtmlVersion.Loose, AttrCheckImpl.CheckBool, true), 
                ...
                new Attribute("open", HtmlVersion.Html5, AttrCheckImpl.CheckBool), 
                new Attribute("pattern", HtmlVersion.Html5, AttrCheckImpl.CheckBool), 
                new Attribute("placeholder", HtmlVersion.Html5, null), 
                ...
                new Attribute("required", HtmlVersion.Html5, AttrCheckImpl.CheckBool), 
                new Attribute("rev", HtmlVersion.All, null), 
                new Attribute("rightmargin", HtmlVersion.Microsoft, null, true), 
                new Attribute("role", HtmlVersion.Html5, null), 
                ...
                new Attribute("sandbox", HtmlVersion.Html5, null), 
                ...
                new Attribute("seamless", HtmlVersion.Html5, AttrCheckImpl.CheckBool), 
                new Attribute("selected", HtmlVersion.All, AttrCheckImpl.CheckBool), 
                new Attribute("shape", HtmlVersion.From32, null, true), 
                new Attribute("showgrid", HtmlVersion.Proprietary, AttrCheckImpl.CheckBool, true), 
                new Attribute("showgridx", HtmlVersion.Proprietary, AttrCheckImpl.CheckBool, true), 
                new Attribute("showgridy", HtmlVersion.Proprietary, AttrCheckImpl.CheckBool, true), 
                new Attribute("size", HtmlVersion.Loose, null), 
                new Attribute("span", HtmlVersion.Html40, null), 
                new Attribute("spellcheck", HtmlVersion.Html5, AttrCheckImpl.CheckBool), 
                new Attribute("src", HtmlVersion.All | HtmlVersion.Frames, AttrCheckImpl.CheckUrl), 
                new Attribute("srcdoc", HtmlVersion.Html5, null), 
                new Attribute("srclang", HtmlVersion.Html5, null), 
                new Attribute("standby", HtmlVersion.Html40, null), 
                new Attribute("start", HtmlVersion.All, null), 
                new Attribute("step", HtmlVersion.Html5, null), 
                ...
                new Attribute("topmargin", HtmlVersion.Microsoft, null, true), 
                new Attribute("translate", HtmlVersion.Html5, AttrCheckImpl.CheckBool), 
                new Attribute("type", HtmlVersion.From32, null), 
                new Attribute("usemap", HtmlVersion.All, AttrCheckImpl.CheckBool), 
                new Attribute("valign", HtmlVersion.From32, AttrCheckImpl.CheckValign, true), 
                ...
                new Attribute("vlink", HtmlVersion.Loose, null, true), 
                new Attribute("vspace", HtmlVersion.Loose, null, true), 
                new Attribute("width", HtmlVersion.All, null, true), 
                new Attribute("wrap", HtmlVersion.Netscape, null, true), 
