        ...
        private static Dict[] _tags = new Dict[]
            {
                ...
                new Dict("base", HtmlVersion.All | HtmlVersion.Frames, ContentModel.Head | ContentModel.Empty | ContentModel.Deprecated, null, null), 
                ...
                new Dict("server", HtmlVersion.Netscape, ContentModel.Head | ContentModel.Mixed | ContentModel.Block | ContentModel.Inline | ContentModel.Deprecated, ParserImpl.ParseScript, null), 
                ...
                new Dict("listing", HtmlVersion.All, ContentModel.Block | ContentModel.Obsolete | ContentModel.Deprecated, ParserImpl.ParsePre, null), 
                ...
                new Dict("multicol", HtmlVersion.Netscape, ContentModel.Block | ContentModel.Deprecated, ParserImpl.ParseBlock, null), 
                ...
                new Dict("align", HtmlVersion.Netscape, ContentModel.Block | ContentModel.Deprecated, ParserImpl.ParseBlock, null), 
                new Dict("center", HtmlVersion.Loose, ContentModel.Block | ContentModel.Deprecated, ParserImpl.ParseBlock, null), 
                new Dict("ins", HtmlVersion.Html40, ContentModel.Inline | ContentModel.Block | ContentModel.Mixed, ParserImpl.ParseInline, null), 
                new Dict("del", HtmlVersion.Html40, ContentModel.Inline | ContentModel.Block | ContentModel.Mixed | ContentModel.Deprecated, ParserImpl.ParseInline, null), 
                ...
                new Dict("applet", HtmlVersion.Loose, ContentModel.Object | ContentModel.Img | ContentModel.Inline | ContentModel.Param | ContentModel.Deprecated, ParserImpl.ParseBlock, null), 
                ...
                new Dict("b", HtmlVersion.All, ContentModel.Inline | ContentModel.Deprecated, ParserImpl.ParseInline, null), 
                new Dict("i", HtmlVersion.All, ContentModel.Inline | ContentModel.Deprecated, ParserImpl.ParseInline, null), 
                new Dict("u", HtmlVersion.Loose, ContentModel.Inline | ContentModel.Deprecated, ParserImpl.ParseInline, null), 
                new Dict("tt", HtmlVersion.All, ContentModel.Inline | ContentModel.Deprecated, ParserImpl.ParseInline, null), 
                new Dict("s", HtmlVersion.Loose, ContentModel.Inline | ContentModel.Deprecated, ParserImpl.ParseInline, null), 
                new Dict("strike", HtmlVersion.Loose, ContentModel.Inline | ContentModel.Deprecated, ParserImpl.ParseInline, null), 
                new Dict("big", HtmlVersion.From32, ContentModel.Inline | ContentModel.Deprecated, ParserImpl.ParseInline, null), 
                new Dict("small", HtmlVersion.From32, ContentModel.Inline | ContentModel.Deprecated, ParserImpl.ParseInline, null), 
                ...
                new Dict("blink", HtmlVersion.Proprietary, ContentModel.Inline | ContentModel.Deprecated, ParserImpl.ParseInline, null), 
                new Dict("nobr", HtmlVersion.Proprietary, ContentModel.Inline, ParserImpl.ParseInline, null), 
                //wbr is now promoted from IE 5 to HTML5
                new Dict("wbr", HtmlVersion.Html5, ContentModel.Inline | ContentModel.Empty, null, null), 
                ...
                new Dict("input", HtmlVersion.All, ContentModel.Inline | ContentModel.Img | ContentModel.Empty, null, CheckAttribsImpl.CheckInput), 
                ...
                new Dict("basefont", HtmlVersion.Loose, ContentModel.Inline | ContentModel.Empty | ContentModel.Deprecated, null, null), 
                new Dict("font", HtmlVersion.Loose, ContentModel.Inline | ContentModel.Deprecated, ParserImpl.ParseInline, null), 
                ...
                new Dict("video", HtmlVersion.Html5, ContentModel.Block, ParserImpl.ParseBlock, null),
                new Dict("audio", HtmlVersion.Html5, ContentModel.Block, ParserImpl.ParseBlock, null),
                new Dict("source", HtmlVersion.Html5, ContentModel.Inline | ContentModel.Empty, ParserImpl.ParseInline, null),
                new Dict("track", HtmlVersion.Html5, ContentModel.Inline | ContentModel.Empty, ParserImpl.ParseInline, null),
                ...
                //should check it's in a menu
                new Dict("menuitem", HtmlVersion.Html5, ContentModel.Inline, ParserImpl.ParseInline, null),
                new Dict("main", HtmlVersion.Html5, ContentModel.Block, ParserImpl.ParseBlock, null),
                ...
                //should check it's in a figure
                new Dict("figcaption", HtmlVersion.Html5, ContentModel.Block, ParserImpl.ParseBlock, null),
                new Dict("details", HtmlVersion.Html5, ContentModel.Block, ParserImpl.ParseBlock, null),
                new Dict("summary", HtmlVersion.Html5, ContentModel.Inline, ParserImpl.ParseInline, null),
                new Dict("datalist", HtmlVersion.Html5, ContentModel.Block, ParserImpl.ParseSelect, null),
                new Dict("progress", HtmlVersion.Html5, ContentModel.Inline, ParserImpl.ParseBlock, null),
                new Dict("meter", HtmlVersion.Html5, ContentModel.Inline, ParserImpl.ParseBlock, null),
                new Dict("output", HtmlVersion.Html5, ContentModel.Inline, ParserImpl.ParseBlock, null),
            };
    }
}