...
namespace TidyNet
{
    ...
    internal class Attribute
    {
        ...
        public Attribute(string name, HtmlVersion versions, IAttrCheck attrCheck)
            : this(name, versions, attrCheck, false)
        {
        }

        public Attribute(string name, HtmlVersion versions, IAttrCheck attrCheck, bool presentational)
        {
            _name = name;
            _nowrap = false;
            _literal = false;
        ...
        public bool Presentational { get; set; }
        public string Name
        {
            get
            {
